...
declare const liveblocksBrowserConfig: <LiveAirNodeUnion extends LiveAirNode<any, any>, Meta extends Lson, LiveblocksPresence extends JsonObject = {}>(createClientProps: Parameters<typeof createClient>[0]) => {
    ...
    useNodeState: <T_2 extends LiveAirNodeUnion, K extends keyof LiveAirNodeState<T_3 extends LiveAirNodeUnion_1 ? T_3 : never> = keyof LiveAirNodeState<T_3 extends LiveAirNodeUnion_1 ? T_3 : never>>(nodeId: string, key: K) => [AirNodeState<T_2>[K], (newValue: AirNodeState<T_2>[K]) => void];
    ...
    useStorage: <T_5>(selector: (root: LiveblocksStorageModel<LiveAirNodeUnion, Meta> extends infer T_6 ? T_6 extends LiveblocksStorageModel<LiveAirNodeUnion, Meta> ? T_6 extends _liveblocks_core.LsonObject ? { readonly [K_1 in keyof T_6]: _liveblocks_core.ToImmutable<Exclude<T_6[K_1], undefined>> | (undefined extends T_6[K_1] ? T_6[K_1] & undefined : never); } : T_6 extends _liveblocks_core.Json ? T_6 : never : never : never) => T_5, isEqual?: ((prev: T_5, curr: T_5) => boolean) | undefined) => T_5;
    RoomProvider: (props: {
        id: string;
