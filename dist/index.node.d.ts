import { L as LiveAirNode, f as LiveblocksPresence, a as LiveblocksStorageModel, A as AirNodeShape, b as AirNodeState, c as LiveAirNodeState } from './data-model-4971424b.js';
export { e as AirNodeMeta, d as AirNodeType, U as UnionToIntersection } from './data-model-4971424b.js';
...
declare const liveblocksNodeConfig: <LiveAirNodeUnion extends LiveAirNode<any, any>, Meta extends Lson>() => {
    ...
    useStorageGetNode: <S extends _liveblocks_core.LsonObject, R_1>(nodeId: string, selector: (nodeState: S extends AirNodeState<infer N extends LiveAirNode<any, any>> ? AirNodeState<N> : never) => R_1 | null) => NonNullable<R_1>;
