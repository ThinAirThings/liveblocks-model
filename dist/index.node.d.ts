...
declare const liveblocksNodeConfig: <LiveAirNodeUnion extends LiveAirNode<any, any>, Meta extends Lson>() => {
    ...
    useStorageGetNodeMap: (nodeFilter?: ((params_0: { [K_1 in AirNodeType<LiveAirNodeUnion>]: string; }, params_1: [string, AirNodeShape<LiveAirNodeUnion>], params_2: number, params_3: [string, AirNodeShape<LiveAirNodeUnion>][]) => boolean) | undefined) => void;
