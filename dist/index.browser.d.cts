import { L as LiveAirNode, a as LiveblocksStorageModel, b as LiveAirNodeShape } from './data-model-7e0da64c.js';
export { d as LiveAirNodeState, c as LiveAirNodeType, e as LiveblocksPresence, N as NodeId, U as UnionToIntersection } from './data-model-7e0da64c.js';
...
declare const liveblocksBrowserConfig: <LiveAirNodeUnion extends LiveAirNode<any, any>, Meta extends Lson, LiveblocksPresence extends JsonObject = {}>(createClientProps: Parameters<typeof createClient>[0]) => {
    ...
    useStorageGetNode: <T_5 extends LiveAirNode<any, any>>(nodeId: string, selector: <R_1 extends unknown>(nodeState: T_5 extends LiveAirNode<any, infer S extends _liveblocks_core.LsonObject> ? _liveblocks_core.ToImmutable<S> : never) => R_1) => unknown;
...
export { LiveAirNode, LiveAirNodeShape, LiveblocksStorageModel, liveblocksBrowserConfig };
